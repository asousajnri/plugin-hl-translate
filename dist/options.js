...
/*!******************************!*\
  !*** ./src/js/libs/index.js ***!
  \******************************/
/*! exports provided: getSelected, translate, composition, storage, operators, store */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_getSelected__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/getSelected */ \"./src/js/libs/modules/getSelected.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"getSelected\", function() { return _modules_getSelected__WEBPACK_IMPORTED_MODULE_0__[\"default\"]; });\n\n/* harmony import */ var _modules_translate__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/translate */ \"./src/js/libs/modules/translate.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"translate\", function() { return _modules_translate__WEBPACK_IMPORTED_MODULE_1__[\"default\"]; });\n\n/* harmony import */ var _modules_composition__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/composition */ \"./src/js/libs/modules/composition.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"composition\", function() { return _modules_composition__WEBPACK_IMPORTED_MODULE_2__[\"default\"]; });\n\n/* harmony import */ var _modules_storage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/storage */ \"./src/js/libs/modules/storage.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"storage\", function() { return _modules_storage__WEBPACK_IMPORTED_MODULE_3__[\"default\"]; });\n\n/* harmony import */ var _modules_operators__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/operators */ \"./src/js/libs/modules/operators.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"operators\", function() { return _modules_operators__WEBPACK_IMPORTED_MODULE_4__[\"default\"]; });\n\n/* harmony import */ var _modules_store__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/store */ \"./src/js/libs/modules/store.js\");\n/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, \"store\", function() { return _modules_store__WEBPACK_IMPORTED_MODULE_5__[\"default\"]; });\n\n\n\n\n\n\n\n\n\n//# sourceURL=webpack:///./src/js/libs/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../api */ \"./src/api.js\");\n/* harmony import */ var _operators__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./operators */ \"./src/js/libs/modules/operators.js\");\n/* harmony import */ var _storage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./storage */ \"./src/js/libs/modules/storage.js\");\nfunction _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }\n\nfunction _nonIterableSpread() { throw new TypeError(\"Invalid attempt to spread non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _iterableToArray(iter) { if (typeof Symbol !== \"undefined\" && Symbol.iterator in Object(iter)) return Array.from(iter); }\n\nfunction _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return _arrayLikeToArray(arr); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\n\n\n\nvar store = function store() {\n  var filter = function filter(word) {\n    return _operators__WEBPACK_IMPORTED_MODULE_1__[\"default\"].filter(get(), word);\n  };\n\n  var find = function find(word) {\n    return _operators__WEBPACK_IMPORTED_MODULE_1__[\"default\"].find(get(), word);\n  };\n\n  var hasWord = function hasWord(word) {\n    return _operators__WEBPACK_IMPORTED_MODULE_1__[\"default\"].hasWord(find(word));\n  };\n\n  var remove = function remove(word) {\n    return set(filter(word));\n  };\n\n  var get = function get() {\n    return _storage__WEBPACK_IMPORTED_MODULE_2__[\"default\"].get('hl-translate');\n  };\n\n  var set = function set(value) {\n    return _storage__WEBPACK_IMPORTED_MODULE_2__[\"default\"].set('hl-translate', value);\n  };\n\n  var add = /*#__PURE__*/function () {\n    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(word, translate) {\n      var oldWords, newWords, updatedWords, resp, teste;\n      return regeneratorRuntime.wrap(function _callee$(_context) {\n        while (1) {\n          switch (_context.prev = _context.next) {\n            case 0:\n              oldWords = get();\n              newWords = {\n                word: word,\n                translate: translate\n              };\n              updatedWords = oldWords ? [].concat(_toConsumableArray(oldWords), [newWords]) : [newWords];\n\n              if (hasWord(word)) {\n                _context.next = 13;\n                break;\n              }\n\n              _context.next = 6;\n              return _api__WEBPACK_IMPORTED_MODULE_0__[\"default\"].get('vocabulary');\n\n            case 6:\n              resp = _context.sent;\n              console.log('TESTANDO API: ', resp);\n              _context.next = 10;\n              return _api__WEBPACK_IMPORTED_MODULE_0__[\"default\"].post('vocabulary-add', {\n                words: updatedWords\n              });\n\n            case 10:\n              teste = _context.sent;\n              console.log('TESTE: >> ', teste);\n              set(updatedWords);\n\n            case 13:\n            case \"end\":\n              return _context.stop();\n          }\n        }\n      }, _callee);\n    }));\n\n    return function add(_x, _x2) {\n      return _ref.apply(this, arguments);\n    };\n  }();\n\n  return {\n    get: get,\n    remove: remove,\n    find: find,\n    hasWord: hasWord,\n    add: add\n  };\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (store());\n\n//# sourceURL=webpack:///./src/js/libs/modules/store.js?");
